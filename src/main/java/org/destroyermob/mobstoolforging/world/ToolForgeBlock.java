...
public class ToolForgeBlock extends ToolWorkstationBlock {
    ...
    private static final VoxelShape NORTH_SHAPE = Shapes.or(
            ...
            Block.box(2.0, 8.0, 5.0, 16.0, 11.0, 11.0),
            Block.box(1.0, 8.0, 6.0, 2.0, 11.0, 10.0),
            Block.box(0.0, 8.0, 7.0, 1.0, 11.0, 9.0),
            Block.box(3.0, 8.0, 4.0, 16.0, 11.0, 5.0),
            Block.box(3.0, 8.0, 11.0, 16.0, 11.0, 12.0)
    ).optimize();
