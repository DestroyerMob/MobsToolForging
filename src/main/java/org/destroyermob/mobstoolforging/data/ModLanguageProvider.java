...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addBlock(ModBlocks.FOUNDRY_FUEL_TANK, "Foundry Fuel Tank");
        addBlock(ModBlocks.FOUNDRY_GLASS, "Foundry Glass");
        addBlock(ModBlocks.FOUNDRY_DRAIN, "Foundry Drain");
        addBlock(ModBlocks.FOUNDRY_FAUCET, "Foundry Faucet");
        addBlock(ModBlocks.FOUNDRY_CASTING_TABLE, "Casting Table");
        addBlock(ModBlocks.FOUNDRY_CASTING_BASIN, "Casting Basin");
        ...
        addItem(ModItems.CASTING_MOLD, "Gold Cast");
        add("item.mobstoolforging.casting_mold.named", "%s Gold Cast");
        ...
        add("material.mobstoolforging.netherite_scrap", "Netherite Scrap");
        ...
        add("jei.mobstoolforging.foundry_melting", "Foundry Melting");
        add("jei.mobstoolforging.foundry_alloying", "Foundry Alloying");
        add("jei.mobstoolforging.foundry_casting", "Foundry Casting");
        add("jei.mobstoolforging.foundry_fuel", "Foundry Fuels");
        add("jei.mobstoolforging.foundry.amount_mb", "%s mB");
        add("jei.mobstoolforging.foundry.temperature_c", "%s°C");
        add("jei.mobstoolforging.foundry.material_amount", "%s: %s mB");
        add("jei.mobstoolforging.foundry.fuel_use", "%s mB fuel");
        add("jei.mobstoolforging.foundry.cast_kind.create_cast", "Pour gold over a part to create a reusable cast");
        add("jei.mobstoolforging.foundry.cast_kind.cast_part", "Pour a metal part with a reusable cast");
        add("jei.mobstoolforging.foundry.cast_kind.cast_ingot", "Pour into an empty Casting Table");
        add("jei.mobstoolforging.foundry.cast_kind.cast_block", "Pour into an empty Casting Basin");
        ...
        add("jei.mobstoolforging.role.foundry_input", "Item to melt");
        add("jei.mobstoolforging.role.molten_input", "Molten input");
        add("jei.mobstoolforging.role.molten_result", "Molten result");
        add("jei.mobstoolforging.role.foundry_fuel", "Foundry fuel");
        add("jei.mobstoolforging.role.foundry_controller", "Foundry controller");
        add("jei.mobstoolforging.role.cast_pattern", "Part used to make the cast");
        add("jei.mobstoolforging.role.casting_mold", "Reusable cast");
        ...
        add("jei.mobstoolforging.material_traits.level_hint", "Shown at Level I. Finished-tool tooltips calculate every combined level.");
        add("jei.mobstoolforging.material_traits.more", "+%s more");
        add("jei.mobstoolforging.material_traits.effect.steady", "Level I: mining ×1.25, attack speed +0.35, and repairs restore 50% more.");
        add("jei.mobstoolforging.material_traits.effect.swift", "Level I: mining ×1.60 and attack speed +0.75, but durability wear is doubled.");
        add("jei.mobstoolforging.material_traits.effect.kindled", "Fireproof; smelts eligible block drops automatically and ignites damaged targets for 5 seconds.");
        add("jei.mobstoolforging.material_traits.effect.reinforced", "Level I: prevents 75% of durability wear and each repair material restores 50%.");
        add("jei.mobstoolforging.material_traits.effect.work_hardened", "As condition falls below 75% / 50% / 25%, mining and damage gain +25% / +50% / +100%.");
        add("jei.mobstoolforging.material_traits.effect.resonant", "Level I: the highest-level installed non-curse enchantment operates 2 effective levels higher.");
        add("jei.mobstoolforging.material_traits.effect.gilded", "With Better Enchanting, each gold component grants +1 enchantment capacity.");
        add("jei.mobstoolforging.material_traits.effect.adamant", "Level I: suitable-block mining ×1.75; attacks bypass 30% of armour mitigation.");
        add("jei.mobstoolforging.material_traits.effect.nether_forged", "Fireproof; Level I doubles durability, multiplies physical base damage by 1.30, and raises eligible heads to diamond harvest tier.");
        add("jei.mobstoolforging.material_traits.effect.fortunate", "Level I: Fortune and Looting operate 2 effective levels higher, including from level zero.");
        add("jei.mobstoolforging.material_traits.effect.keen", "Level I: suitable-block mining ×1.15 and physical damage ×1.35.");
        add("jei.mobstoolforging.material_traits.effect.forceful", "Level I: suitable-block mining ×1.30 and physical damage ×1.60, but wear ×1.50.");
        add("jei.mobstoolforging.material_traits.effect.jagged", "Level I: suitable-block mining ×1.20 and physical damage ×1.35, but wear ×2.");
        add("jei.mobstoolforging.material_traits.effect.tensioned", "Crossbows gain effective Quick Charge II and deal 30% more projectile damage at Level I.");
        add("jei.mobstoolforging.material_traits.effect.focused", "Level I: mining ×1.15 and attack speed +0.55; ignores air/water penalties and grants effective Quick Charge II.");
        ...
        add("jei.mobstoolforging.material_traits.source.string", "Crossbow string");
        ...
        add("jade.mobstoolforging.foundry_fuel", "%s: %s/%s mB (%s%%)");
        add("jade.mobstoolforging.foundry_fuel_temperature", "Fuel Temperature: %s");
        add("jade.mobstoolforging.foundry_temperature_ready", "Temperature: %s / %s required");
        add("jade.mobstoolforging.foundry_temperature_low", "Too Cool: %s / %s required");
        add("jade.mobstoolforging.foundry_molten", "Molten Metal: %s/%s mB (%s%%)");
        add("jade.mobstoolforging.foundry_molten_unformed", "Molten Metal: %s mB (Unformed)");
        add("jade.mobstoolforging.foundry_layer", "%s: %s mB");
        add("jade.mobstoolforging.foundry_next_layer", "Next Pour — %s: %s mB");
        add("jade.mobstoolforging.foundry_next_empty", "Next Pour — Empty");
        add("jade.mobstoolforging.foundry_solids", "Solid Inputs: %s item(s)");
        add("jade.mobstoolforging.foundry_melting", "Melting: %s (%s%%)");
        add("jade.mobstoolforging.foundry_connected_fuel", "Connected Fuel: %s mB across %s tank(s)");
        add("jade.mobstoolforging.foundry_dimensions", "Interior: %s×%s×%s blocks");
        add("jade.mobstoolforging.foundry_casting_ready", "Ready: %s — use to collect");
        add("jade.mobstoolforging.foundry_casting_cooling", "Cooling: %s, %s left");
        add("jade.mobstoolforging.foundry_casting_filling", "Filling: %s, %s/%s mB");
        add("jade.mobstoolforging.foundry_casting_form", "Form: %s — open the faucet to pour");
        add("jade.mobstoolforging.foundry_casting_product", "cast product");
        add("jade.mobstoolforging.foundry_casting_empty_table", "Empty — pours one ingot without a form");
        add("jade.mobstoolforging.foundry_casting_empty_basin", "Empty — pours one storage block");
        add("jade.mobstoolforging.foundry_faucet_open", "Open");
        add("jade.mobstoolforging.foundry_faucet_closed", "Closed");
        add("jade.mobstoolforging.foundry_faucet_pouring", "Pouring: %s");
        ...
        add("config.jade.plugin_mobstoolforging.foundry_fuel_tank", "Foundry Fuel Tank");
        add("config.jade.plugin_mobstoolforging.foundry_contents", "Foundry Contents");
        add("config.jade.plugin_mobstoolforging.foundry_drain", "Foundry Drain");
        add("config.jade.plugin_mobstoolforging.foundry_casting", "Foundry Casting");
        add("config.jade.plugin_mobstoolforging.foundry_faucet", "Foundry Faucet");
        ...
        add("message.mobstoolforging.foundry_tank_filled", "Fuel tank: %s, %s/%s mB, temperature %s.");
        add("message.mobstoolforging.foundry_tank_rejected", "That fluid cannot be transferred here (tank %s/%s mB). Check that it is a registered foundry fuel and matches the tank contents.");
        add("message.mobstoolforging.foundry_tank_status", "Foundry fuel tank: %s, %s/%s mB, temperature %s.");
        add("message.mobstoolforging.foundry_tank_empty", "Empty");
        ...
        add("message.mobstoolforging.foundry_structure.invalid_controller", "The foundry controller is invalid at %s, %s, %s.");
        add("message.mobstoolforging.foundry_structure.entrance_blocked", "Clear the first interior block behind the controller at %s, %s, %s.");
        add("message.mobstoolforging.foundry_structure.side_wall_missing", "Add a tagged foundry side wall within nine interior blocks; check %s, %s, %s.");
        add("message.mobstoolforging.foundry_structure.back_wall_missing", "Add a tagged foundry back wall within nine interior blocks; check %s, %s, %s.");
        add("message.mobstoolforging.foundry_structure.wall_path_blocked", "Remove the non-foundry block between the interior and wall at %s, %s, %s.");
        add("message.mobstoolforging.foundry_structure.too_wide", "The interior is wider than nine blocks near %s, %s, %s.");
        add("message.mobstoolforging.foundry_structure.too_deep", "The interior is deeper than nine blocks near %s, %s, %s.");
        add("message.mobstoolforging.foundry_structure.floor_missing", "Add a tagged foundry floor block at %s, %s, %s.");
        add("message.mobstoolforging.foundry_structure.floor_invalid", "Replace the floor block at %s, %s, %s with a tagged foundry block.");
        add("message.mobstoolforging.foundry_structure.wall_missing", "Add a tagged foundry wall block at %s, %s, %s.");
        add("message.mobstoolforging.foundry_structure.wall_invalid", "Replace the wall block at %s, %s, %s with a tagged foundry block.");
        add("message.mobstoolforging.foundry_structure.extra_controller", "Remove the extra Foundry Forge at %s, %s, %s.");
        add("message.mobstoolforging.foundry_structure.interior_blocked", "Clear the foundry interior at %s, %s, %s.");
        add("message.mobstoolforging.foundry_structure.top_blocked", "Open the top of the foundry by clearing %s, %s, %s.");
        add("message.mobstoolforging.foundry_structure.contents_exceed_capacity", "The foundry contains %s mB but this structure only holds %s mB; restore a larger wall.");
        add("message.mobstoolforging.foundry_operation.add_metal", "Idle: add a registered metal item.");
        add("message.mobstoolforging.foundry_operation.ready_to_pour", "Molten metal is ready at the drain.");
        add("message.mobstoolforging.foundry_operation.add_tank", "Waiting: replace a wall block with a Foundry Fuel Tank.");
        add("message.mobstoolforging.foundry_operation.add_fuel", "Waiting: fill a connected Foundry Fuel Tank.");
        ...
        add("message.mobstoolforging.foundry_faucet.needs_receiver", "Place a Casting Table or Casting Basin directly below the faucet.");
        add("message.mobstoolforging.foundry_faucet.unconnected", "The attached drain is not part of a formed foundry.");
        add("message.mobstoolforging.foundry_faucet.no_molten", "The foundry has no molten metal at the drain.");
        add("message.mobstoolforging.foundry_faucet.take_output", "Collect the finished casting before pouring again.");
        add("message.mobstoolforging.foundry_faucet.cooling", "Wait for the current casting to cool.");
        add("message.mobstoolforging.foundry_faucet.receiver_blocked", "This receiver cannot accept the bottom molten layer; check its form and contents.");
        add("message.mobstoolforging.foundry_lit", "Foundry %sx%sx%s melting: %s solids, %s/%s mB molten, %s mB fuel, heat %s/%s.");
        add("message.mobstoolforging.foundry_status", "Foundry %sx%sx%s formed: %s solids, %s/%s mB molten, %s mB fuel, heat %s/%s.");
        ...
        add("advancement.mobstoolforging.foundry.first_cast.description", "Create a reusable gold casting mold.");
        add("advancement.mobstoolforging.foundry.bronze_age.title", "The Bronze Age");
        ...
        add("tooltip.mobstoolforging.workmanship_score", "Effective score: %s (hammered: %s)");
        add("tooltip.mobstoolforging.metallurgy.origin", "Manufacture");
        add("tooltip.mobstoolforging.metallurgy.defect", "Defect");
        add("tooltip.mobstoolforging.metallurgy.heat_treatment", "Heat Treatment");
        add("tooltip.mobstoolforging.metallurgy.composition", "Composition: %s");
        add("tooltip.mobstoolforging.metallurgy.composition_entry", "%s %s%%");
        add("tooltip.mobstoolforging.metallurgy.parts", "Part Metallurgy");
        add("tooltip.mobstoolforging.metallurgy.part_summary", "  %s — %s, %s");
        add("metallurgy.mobstoolforging.origin.forged", "Forged");
        add("metallurgy.mobstoolforging.origin.cast", "Cast");
        add("metallurgy.mobstoolforging.origin.reforged", "Reforged");
        add("metallurgy.mobstoolforging.origin.recycled", "Recycled");
        add("metallurgy.mobstoolforging.defect.none", "None");
        add("metallurgy.mobstoolforging.defect.porosity", "Casting Porosity");
        add("metallurgy.mobstoolforging.heat_treatment.untreated", "Untreated");
        add("metallurgy.mobstoolforging.heat_treatment.hardened", "Hardened");
        add("metallurgy.mobstoolforging.heat_treatment.tempering", "Tempering");
        add("metallurgy.mobstoolforging.heat_treatment.tempered", "Tempered");
        add("metallurgy.mobstoolforging.heat_treatment.brittle", "Brittle");
        add("material.mobstoolforging.steel", "Steel");
        add("material.mobstoolforging.bronze", "Bronze");
        add("material.mobstoolforging.carbon", "Carbon");
        add("material.c.tin", "Tin");
        ...
        add("tooltip.mobstoolforging.effective_stats", "Effective Stats");
        add("tooltip.mobstoolforging.effective_attack_damage", "Attack Damage: %s");
        add("tooltip.mobstoolforging.effective_attack_damage_with_base", "Attack Damage: %s (physical %s)");
        add("tooltip.mobstoolforging.effective_attack_speed", "Attack Speed: %s attacks/s");
        add("tooltip.mobstoolforging.effective_mining_speed", "Suitable-Block Tool Speed: %s");
        add("tooltip.mobstoolforging.effective_mining_speed_with_base", "Suitable-Block Tool Speed: %s (tool %s)");
        add("tooltip.mobstoolforging.effective_durability", "Durability: %s / %s");
        add("tooltip.mobstoolforging.effective_charge_time", "Charge Time: %s s (%s ticks)");
        add("tooltip.mobstoolforging.effective_projectile_damage", "Projectile Damage Multiplier: ×%s");
        add("tooltip.mobstoolforging.effective_current_output", "Current Condition Output: ×%s");
        add("tooltip.mobstoolforging.effective_scope", "Attack damage includes full-strength unconditional item enchantments; target, wielder, critical, and stance effects are excluded.");
        ...
        add("tooltip.mobstoolforging.stat.physical_damage_multiplier", "Physical Damage Multiplier");
        ...
        add("tooltip.mobstoolforging.trait.steady.desc", "improves mining, handling, and repair strength");
        add("tooltip.mobstoolforging.trait.steady.effect", "Mining ×%s; attack speed +%s; repairs restore %s%% more");
        add("tooltip.mobstoolforging.trait.swift", "Swift");
        add("tooltip.mobstoolforging.trait.swift.desc", "greatly improves mining and handling at the cost of wear");
        add("tooltip.mobstoolforging.trait.swift.effect", "Mining ×%s; attack speed +%s; durability wear ×%s");
        add("tooltip.mobstoolforging.trait.kindled", "Kindled");
        add("tooltip.mobstoolforging.trait.kindled.desc", "is fireproof, smelts eligible drops, and ignites damaged targets");
        add("tooltip.mobstoolforging.trait.kindled.effect", "Fireproof; smelts eligible drops; damaged targets burn for %s seconds");
        add("tooltip.mobstoolforging.trait.reinforced", "Reinforced");
        add("tooltip.mobstoolforging.trait.reinforced.desc", "prevents most wear and makes repair materials restore half the tool");
        add("tooltip.mobstoolforging.trait.reinforced.effect", "Prevents %s%% of wear; each repair material restores %s%% durability");
        add("tooltip.mobstoolforging.trait.resonant", "Resonant");
        add("tooltip.mobstoolforging.trait.resonant.desc", "raises the strongest installed non-curse enchantment");
        add("tooltip.mobstoolforging.trait.resonant.effect", "Strongest installed non-curse enchantment gains +%s effective levels");
        add("tooltip.mobstoolforging.trait.work_hardened", "Work-Hardened");
        add("tooltip.mobstoolforging.trait.work_hardened.desc", "gains mining and damage as its condition falls");
        add("tooltip.mobstoolforging.trait.work_hardened.effect", "Below 75%% / 50%% / 25%% condition: mining and damage +%s%% / +%s%% / +%s%%");
        add("tooltip.mobstoolforging.trait.gilded", "Gilded");
        add("tooltip.mobstoolforging.trait.gilded.desc", "adds Better Enchanting capacity for every gold component");
        add("tooltip.mobstoolforging.trait.gilded.effect", "Grants +%s enchantment capacity with Better Enchanting");
        add("tooltip.mobstoolforging.trait.adamant", "Adamant");
        add("tooltip.mobstoolforging.trait.adamant.desc", "provides unmatched general mining and bypasses armour mitigation");
        add("tooltip.mobstoolforging.trait.adamant.effect", "Suitable-block mining ×%s; attacks bypass %s%% of armour mitigation");
        add("tooltip.mobstoolforging.trait.nether_forged", "Nether-Forged");
        add("tooltip.mobstoolforging.trait.nether_forged.desc", "is fireproof and improves durability, damage, and harvest tier");
        add("tooltip.mobstoolforging.trait.nether_forged.effect", "Fireproof; durability ×%s; physical damage ×%s; eligible heads gain diamond harvest tier");
        add("tooltip.mobstoolforging.trait.fortunate", "Fortunate");
        add("tooltip.mobstoolforging.trait.fortunate.desc", "raises effective Fortune and Looting, including from level zero");
        add("tooltip.mobstoolforging.trait.fortunate.effect", "Fortune and Looting gain +%s effective levels, including from level zero");
        add("tooltip.mobstoolforging.trait.keen", "Keen");
        add("tooltip.mobstoolforging.trait.keen.desc", "favours physical damage while retaining modest mining utility");
        add("tooltip.mobstoolforging.trait.keen.effect", "Suitable-block mining ×%s; physical damage ×%s");
        add("tooltip.mobstoolforging.trait.forceful", "Forceful");
        add("tooltip.mobstoolforging.trait.forceful.desc", "delivers extreme physical damage with increased wear");
        add("tooltip.mobstoolforging.trait.forceful.effect", "Suitable-block mining ×%s; physical damage ×%s; durability wear ×%s");
        add("tooltip.mobstoolforging.trait.jagged", "Jagged");
        add("tooltip.mobstoolforging.trait.jagged.desc", "provides cheap early output with severe wear");
        add("tooltip.mobstoolforging.trait.jagged.effect", "Suitable-block mining ×%s; physical damage ×%s; durability wear ×%s");
        add("tooltip.mobstoolforging.trait.tensioned", "Tensioned");
        add("tooltip.mobstoolforging.trait.tensioned.desc", "improves crossbow charge speed and projectile damage");
        add("tooltip.mobstoolforging.trait.tensioned.effect", "Crossbows gain +%s effective Quick Charge levels; projectile damage ×%s");
        add("tooltip.mobstoolforging.trait.focused", "Focused");
        add("tooltip.mobstoolforging.trait.focused.desc", "improves handling and removes air and water mining penalties");
        add("tooltip.mobstoolforging.trait.focused.effect", "Mining ×%s; attack speed +%s; no air/water penalty; Quick Charge +%s");
