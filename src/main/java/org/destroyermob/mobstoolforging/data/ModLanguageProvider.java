...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("jei.mobstoolforging.material_traits.level_hint", "Every matching component adds a level; repeated levels have diminishing returns.");
        ...
        add("jei.mobstoolforging.material_traits.effect.adamant", "Level I: mines suitable blocks 35% faster and attacks ignore 30% of armor.");
        ...
        add("jei.mobstoolforging.material_traits.effect.keen", "Level I: multiplies suitable-block mining speed by 1.50 and physical base damage by 1.35.");
        add("jei.mobstoolforging.material_traits.effect.forceful", "Level I: multiplies mining speed and physical base damage by 1.60, but durability wear by 1.50.");
        add("jei.mobstoolforging.material_traits.effect.jagged", "Level I: multiplies mining speed and physical base damage by 1.35, but doubles durability wear.");
        ...
        add("jei.mobstoolforging.material_traits.effect.focused", "Level I: mining ×1.30 and attack speed +0.55; ignores airborne/underwater mining penalties and grants effective Quick Charge II.");
        ...
        add("tooltip.mobstoolforging.trait.steady.desc", "25% faster mining, +0.35 attack speed, and 50% stronger repairs");
        add("tooltip.mobstoolforging.trait.swift", "Swift");
        add("tooltip.mobstoolforging.trait.swift.desc", "60% faster mining and +0.75 attack speed, but doubles wear");
        add("tooltip.mobstoolforging.trait.kindled", "Kindled");
        add("tooltip.mobstoolforging.trait.kindled.desc", "is fireproof, auto-smelts block drops, and ignites targets");
        add("tooltip.mobstoolforging.trait.reinforced", "Reinforced");
        add("tooltip.mobstoolforging.trait.reinforced.desc", "prevents 75% of wear and makes each repair restore half its durability");
        add("tooltip.mobstoolforging.trait.resonant", "Resonant");
        add("tooltip.mobstoolforging.trait.resonant.desc", "raises the highest-level installed non-curse enchantment by 2 effective levels");
        add("tooltip.mobstoolforging.trait.work_hardened", "Work-Hardened");
        add("tooltip.mobstoolforging.trait.work_hardened.desc", "gains 25%, 50%, then 100% output as its condition falls");
        add("tooltip.mobstoolforging.trait.gilded", "Gilded");
        add("tooltip.mobstoolforging.trait.gilded.desc", "grants one extra enchantment slot per gold component with Better Enchanting");
        add("tooltip.mobstoolforging.trait.adamant", "Adamant");
        add("tooltip.mobstoolforging.trait.adamant.desc", "mines suitable blocks 35% faster and ignores 30% of armor");
        add("tooltip.mobstoolforging.trait.nether_forged", "Nether-Forged");
        add("tooltip.mobstoolforging.trait.nether_forged.desc", "is fireproof, doubles durability, multiplies physical base damage by 1.30, and improves harvest tier");
        add("tooltip.mobstoolforging.trait.fortunate", "Fortunate");
        add("tooltip.mobstoolforging.trait.fortunate.desc", "raises effective Fortune and Looting by 2 levels");
        add("tooltip.mobstoolforging.trait.keen", "Keen");
        add("tooltip.mobstoolforging.trait.keen.desc", "multiplies suitable-block mining speed by 1.50 and physical base damage by 1.35");
        add("tooltip.mobstoolforging.trait.forceful", "Forceful");
        add("tooltip.mobstoolforging.trait.forceful.desc", "multiplies mining speed and physical base damage by 1.60 but wear by 1.50");
        add("tooltip.mobstoolforging.trait.jagged", "Jagged");
        add("tooltip.mobstoolforging.trait.jagged.desc", "multiplies mining speed and physical base damage by 1.35 but doubles wear");
        add("tooltip.mobstoolforging.trait.tensioned", "Tensioned");
        add("tooltip.mobstoolforging.trait.tensioned.desc", "grants effective Quick Charge II and 30% more projectile damage");
        add("tooltip.mobstoolforging.trait.focused", "Focused");
        add("tooltip.mobstoolforging.trait.focused.desc", "improves handling, ignores air/water mining penalties, and grants effective Quick Charge II");
