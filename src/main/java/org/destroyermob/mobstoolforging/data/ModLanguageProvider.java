...
public class ModLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        addItem(ModItems.HELMET_COMB, "Helmet Comb");
        addItem(ModItems.HELMET_VISOR, "Helmet Visor");
        addItem(ModItems.CHESTPLATE_BODY, "Body Armour Piece");
        addItem(ModItems.LEGGINGS_LEGS, "Leggings Base");
        addItem(ModItems.LEGGINGS_KNEES, "Knee Plates");
        addItem(ModItems.LEGGINGS_TASSETS, "Tassets");
        ...
        add("item.mobstoolforging.material_helmet_comb", "%s Helmet Comb");
        add("item.mobstoolforging.material_helmet_visor", "%s Helmet Visor");
        ...
        add("item.mobstoolforging.material_leggings_knees", "%s Knee Plates");
        add("item.mobstoolforging.material_leggings_tassets", "%s Tassets");
