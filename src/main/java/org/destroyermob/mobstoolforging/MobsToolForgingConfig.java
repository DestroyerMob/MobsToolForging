...
public final class MobsToolForgingConfig {
    ...
    static {
        ...
        CONVERT_VANILLA_LOOT_TO_MODULAR_TOOLS = builder
                .comment("When true, vanilla tools, weapons, and non-leather armor generated by loot tables or equipped by hostile mobs are replaced with Mobs Tool Forging modular equivalents.")
